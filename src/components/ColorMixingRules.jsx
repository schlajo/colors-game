  ...
  return (
    <div className="instruction-panel lg:w-1/2 w-full text-center mt-2 lg:mt-4 bg-gray-800 p-4 rounded-lg">
      ...
      <div className="text-gray-300 text-left">
        <span>
          With additive color-mixing (RGB), we start with darkness (black) and add
          colored light. We see light directly emitted from a source, like a TV.
          This model's three primary colors (red, green, and blue) can combine to
          make white.
          <br />
          <br />
          But with subtractive color-mixing (CMY), we see light that has bounced
          off of an object, with certain wavelengths absorbed by the pigments. We
          start with white, like a sheet of paper, and subtract light through
          pigments. A red apple appears red because it absorbs most
          wavelengths but reflects primarily red light back to our eyes.
          <br />
          <br />
          On ink cartridges, the letters CMYK refer to cyan, magenta, yellow, and
          black. Cartridges include black ink even though CMY's three primary
          colors could combine to make black.
        </span>
      </div>
    </div>
  );
