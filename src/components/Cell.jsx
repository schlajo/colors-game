  ...
  <div
    className={`w-[min(8vw,36px)] h-[min(8vw,36px)] rounded-full flex items-center justify-center
      ${cell.color === 'blue' ? 'bg-blue-500':
        ...
        cell.color === 'white' ? 'bg-gray-400' : 'bg-gray-200'
      }`}
  >
    <span
    ...
    >
      ...
      {cell.isIncorrect && (
        ...
        >
          <line x1="10" y1="10" x2="90" y2="90" stroke="red" strokeWidth="10" strokeLinecap="round" />
          <line x1="10" y1="90" x2="90" y2="10" stroke="red" strokeWidth="10" strokeLinecap="round" />
        </svg>
      )}
    </div>
  );
